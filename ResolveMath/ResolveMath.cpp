...
void ResolveMathPluginFactory::describeInContext(ImageEffectDescriptor& p_Desc, ContextEnum /*p_Context*/)
{
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathR);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathG);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathB);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathLUT);
param->setLabel(kParamResolveMathLUTLabel);
param->setHint(kParamResolveMathLUTHint);
