...
"*BB = B; \n" \
"} \n" \
"__kernel void k_videoGradeKernel(__global const float* p_Input, __global float* p_Output, int p_Width, int p_Height, int p_LumaMath, int p_Gang,  \n" \
...
cl_kernel VideoGrade = NULL;

VideoGrade = clCreateKernel(program, "k_videoGradeKernel", &error);
...
error = clSetKernelArg(VideoGrade, 0, sizeof(cl_mem), &p_Input);
error |= clSetKernelArg(VideoGrade, 1, sizeof(cl_mem), &p_Output);
error |= clSetKernelArg(VideoGrade, 2, sizeof(int), &p_Width);
error |= clSetKernelArg(VideoGrade, 3, sizeof(int), &p_Height);
error |= clSetKernelArg(VideoGrade, 4, sizeof(int), &p_LumaMath);
error |= clSetKernelArg(VideoGrade, 5, sizeof(int), &p_Switch[0]);
error |= clSetKernelArg(VideoGrade, 6, sizeof(int), &p_Switch[1]);
error |= clSetKernelArg(VideoGrade, 7, sizeof(int), &p_Display);
error |= clSetKernelArg(VideoGrade, 8, sizeof(float), &p_Scales[0]);
error |= clSetKernelArg(VideoGrade, 9, sizeof(float), &p_Scales[1]);
error |= clSetKernelArg(VideoGrade, 10, sizeof(float), &p_Scales[2]);
error |= clSetKernelArg(VideoGrade, 11, sizeof(float), &p_Scales[3]);
error |= clSetKernelArg(VideoGrade, 12, sizeof(float), &p_Scales[4]);
error |= clSetKernelArg(VideoGrade, 13, sizeof(float), &p_Scales[5]);
error |= clSetKernelArg(VideoGrade, 14, sizeof(float), &p_Scales[6]);
error |= clSetKernelArg(VideoGrade, 15, sizeof(float), &p_Scales[7]);
error |= clSetKernelArg(VideoGrade, 16, sizeof(float), &p_Scales[8]);
error |= clSetKernelArg(VideoGrade, 17, sizeof(float), &p_Scales[9]);
error |= clSetKernelArg(VideoGrade, 18, sizeof(float), &p_Scales[10]);
error |= clSetKernelArg(VideoGrade, 19, sizeof(float), &p_Scales[11]);
error |= clSetKernelArg(VideoGrade, 20, sizeof(float), &p_Scales[12]);
error |= clSetKernelArg(VideoGrade, 21, sizeof(float), &p_Scales[13]);
error |= clSetKernelArg(VideoGrade, 22, sizeof(float), &p_Scales[14]);
error |= clSetKernelArg(VideoGrade, 23, sizeof(float), &p_Scales[15]);
error |= clSetKernelArg(VideoGrade, 24, sizeof(float), &p_Scales[16]);
error |= clSetKernelArg(VideoGrade, 25, sizeof(float), &p_Scales[17]);
error |= clSetKernelArg(VideoGrade, 26, sizeof(float), &p_Scales[18]);
error |= clSetKernelArg(VideoGrade, 27, sizeof(float), &p_Scales[19]);
error |= clSetKernelArg(VideoGrade, 28, sizeof(float), &p_Scales[20]);
CheckError(error, "Unable to set kernel arguments");

clEnqueueNDRangeKernel(cmdQ, VideoGrade, 2, NULL, globalWorkSize, localWorkSize, 0, NULL, NULL);
}