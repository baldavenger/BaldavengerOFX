...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr1Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr2Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr3Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr4Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr5Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr6Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr7Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr8Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamExpr9Name);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathxtraR);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathxtraG);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathxtraB);
...
param->setRange(0.0, 0.0, 0.0, 4.0, 4.0, 4.0);
...
{
StringParamDescriptor* param = p_Desc.defineStringParam("name2");
param->setLabel("Name");
param->setHint("overwrites if the same");
param->setDefault("ResolveMath");
...
{
ChoiceParamDescriptor *param = p_Desc.defineChoiceParam(kParamLUT);
param->setLabel(kParamLUTLabel);
param->setHint(kParamLUTHint);
assert(param->getNOptions() == (int)eLUT3D);
param->appendOption(kParamLUTOption3D, kParamLUTOption3DHint);
assert(param->getNOptions() == (int)eLUT1D);
param->appendOption(kParamLUTOption1D, kParamLUTOption1DHint);
assert(param->getNOptions() == (int)eLUTCombo);
param->appendOption(kParamLUTOptionCombo, kParamLUTOptionComboHint);
param->setDefault( (int)eLUT3D );
param->setAnimates(false);
param->setParent(*lutexport);
page->addChild(*param);
}
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamResolveMathxtraLUT);
param->setLabel(kParamResolveMathxtraLUTLabel);
param->setHint(kParamResolveMathxtraLUTHint);
param->setDefault("input");
param->setAnimates(false);
...
{
Double2DParamDescriptor* param = p_Desc.defineDouble2DParam("range1");
param->setLabel("1D Input Range");
param->setHint("set input range for LUT");
...
{
IntParamDescriptor* Param = p_Desc.defineIntParam("lutsize");
Param->setLabel("1D size");
Param->setHint("1D lut size in bytes");
Param->setDefault(12);
Param->setRange(1, 14);
Param->setDisplayRange(8, 14);
Param->setIsSecretAndDisabled(true);
Param->setParent(*lutexport);
page->addChild(*Param);
}
{
Double2DParamDescriptor* param = p_Desc.defineDouble2DParam("range2");
...
Param->setDefault(33);
Param->setRange(2, 129);
Param->setDisplayRange(3, 129);
Param->setParent(*lutexport);
page->addChild(*Param);
}
{
IntParamDescriptor* Param = p_Desc.defineIntParam("precision");
Param->setLabel("precision");
Param->setHint("number of decimal points");
Param->setDefault(6);
Param->setRange(1, 12);
Param->setDisplayRange(3, 10);
Param->setParent(*lutexport);
page->addChild(*Param);
}
{
