...
float *p_GCompress, int p_GInvert, float *p_Lum, int p_DISPLAY, int p_LIMIT, int p_EOTF, int p_SURROUND, int *p_SWitch);
...
_invrrt, _odt, _invodt, _exposure, _lmtscale, _gcompress, _ginvert, _lum, _display, _limit, _eotf, _surround, _switch);
}
