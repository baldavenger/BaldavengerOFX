#ifndef _FREQUENCYCUDAKERNEL_CU_
#define _FREQUENCYCUDAKERNEL_CU_
...
__global__ void DisplayThreshold(int p_Width, int p_Height, float* p_Input)
{
   ...
   if ((x < p_Width) && (y < p_Height))
   {
	 ...
	 p_Input[index + 1] = p_Input[index];
	 p_Input[index + 2] = p_Input[index];
   }
}
