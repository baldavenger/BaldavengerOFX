...
inline float lin_to_log2_32f( float lin, float middleGrey, float minExposure, float maxExposure) 
{
...
inline float Lin_to_Log2_param( float3 In, float middleGrey, float minExposure, float maxExposure)
{
float3 out;	
