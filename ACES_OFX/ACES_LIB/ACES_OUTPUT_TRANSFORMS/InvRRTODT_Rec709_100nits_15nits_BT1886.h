#ifndef __INVRRTODT_REC709_100NITS_15NITS_BT1886_H_INCLUDED__
#define __INVRRTODT_REC709_100NITS_15NITS_BT1886_H_INCLUDED__
...
__device__ inline float3 InvRRTODT_Rec709_100nits_15nits_BT1886( float3 aces) 
{
float Y_MIN = 0.0001f;
float Y_MID = 15.0f;
float Y_MAX = 100.0f;    
