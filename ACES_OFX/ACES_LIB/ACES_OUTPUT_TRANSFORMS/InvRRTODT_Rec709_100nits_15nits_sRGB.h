#ifndef __INVRRTODT_REC709_100NITS_15NITS_SRGB_H_INCLUDED__
#define __INVRRTODT_REC709_100NITS_15NITS_SRGB_H_INCLUDED__
...
__device__ inline float3 InvRRTODT_Rec709_100nits_15nits_sRGB( float3 aces) 
{
float Y_MIN = 0.0001f;
float Y_MID = 15.0f;
float Y_MAX = 100.0f;    
