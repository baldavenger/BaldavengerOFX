...
static DoubleParamDescriptor* defineScaleParam(ImageEffectDescriptor& p_Desc, const std::string& p_Name, const std::string& p_Label, 
...
{
ChoiceParamDescriptor *param = p_Desc.defineChoiceParam(kParamSHAPER);
param->setLabel(kParamSHAPERLabel);
param->setHint(kParamSHAPERHint);
assert(param->getNOptions() == (int)eSHAPERBypass);
param->appendOption(kParamSHAPEROptionBypass, kParamSHAPEROptionBypassHint);
assert(param->getNOptions() == (int)eSHAPERACEScc);
param->appendOption(kParamSHAPEROptionACEScc, kParamSHAPEROptionACESccHint);
assert(param->getNOptions() == (int)eSHAPERACEScct);
param->appendOption(kParamSHAPEROptionACEScct, kParamSHAPEROptionACEScctHint);
assert(param->getNOptions() == (int)eSHAPERACEScustom);
param->appendOption(kParamSHAPEROptionACEScustom, kParamSHAPEROptionACEScustomHint);
param->setDefault( (int)eSHAPERBypass );
param->setAnimates(false);
param->setParent(*lutexport);
page->addChild(*param);
}
{
StringParamDescriptor* param = p_Desc.defineStringParam(kParamMathLUT);
param->setLabel(kParamMathLUTLabel);
param->setHint(kParamMathLUTHint);
param->setDefault("x");
param->setAnimates(false);
param->setIsSecretAndDisabled(true);
param->setParent(*lutexport);
