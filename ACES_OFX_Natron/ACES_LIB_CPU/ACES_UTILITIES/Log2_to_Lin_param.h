...
inline float log2_to_lin_32f( float logNorm, float middleGrey, float minExposure, float maxExposure)
{
...
inline float3 Log2_to_Lin_param( float3 In, float middleGrey, float minExposure, float maxExposure)
{
float3 out;
