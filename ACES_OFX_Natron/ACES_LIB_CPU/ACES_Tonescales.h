...
float inline segmented_spline_c5_fwd( float x)
{
...
float inline segmented_spline_c5_rev
  ( 
    float y
  )
{  
  ...
  float logy = log10f( fmaxf(y,1e-10));
...
inline float segmented_spline_c9_fwd
  ( 
    float x,
...
float inline segmented_spline_c9_rev
  ( 
    float y,
    SegmentedSplineParams_c9 C
  )
