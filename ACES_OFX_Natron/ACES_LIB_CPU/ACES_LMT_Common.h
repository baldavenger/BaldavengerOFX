...
inline float3 gamma_adjust_linear( 
    float3 rgbIn, 
    float GAMMA, 
    float PIVOT = 0.18f
)
...
const float sqrt3over4 = 0.433012701892219f;  // sqrt(3.)/4.
